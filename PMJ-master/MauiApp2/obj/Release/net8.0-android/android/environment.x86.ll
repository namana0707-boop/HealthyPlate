...
@dso_cache = dso_local local_unnamed_addr global [1052 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 26178492, ; hash 0x18f73bc, from name: libaot-MauiApp2.dll.so
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 275081953, ; hash 0x10656ae1, from name: OpenAI
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 591940371, ; hash 0x23484b13, from name: OpenAI.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.49_name, ; name: libaot-OpenAI.dll.so
		ptr null; void* handle (0x0)
	}, ; 123
	...
	%struct.DSOCacheEntry {
		i64 856421639, ; hash 0x330bf507, from name: aot-OpenAI.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.49_name, ; name: libaot-OpenAI.dll.so
		ptr null; void* handle (0x0)
	}, ; 186
	...
	%struct.DSOCacheEntry {
		i64 880355581, ; hash 0x347928fd, from name: MauiApp2.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.12_name, ; name: libaot-MauiApp2.dll.so
		ptr null; void* handle (0x0)
	}, ; 195
	%struct.DSOCacheEntry {
		i64 882979964, ; hash 0x34a1347c, from name: aot-OpenAI
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.49_name, ; name: libaot-OpenAI.dll.so
		ptr null; void* handle (0x0)
	}, ; 196
	...
	%struct.DSOCacheEntry {
		i64 1608641509, ; hash 0x5fe1ebe5, from name: libaot-MauiApp2
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.12_name, ; name: libaot-MauiApp2.dll.so
		ptr null; void* handle (0x0)
	}, ; 358
	...
	%struct.DSOCacheEntry {
		i64 1855477819, ; hash 0x6e98583b, from name: libaot-OpenAI.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.49_name, ; name: libaot-OpenAI.dll.so
		ptr null; void* handle (0x0)
	}, ; 426
	...
	%struct.DSOCacheEntry {
		i64 3168196987, ; hash 0xbcd6d97b, from name: aot-MauiApp2
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.12_name, ; name: libaot-MauiApp2.dll.so
		ptr null; void* handle (0x0)
	}, ; 785
	...
	%struct.DSOCacheEntry {
		i64 3241485502, ; hash 0xc13524be, from name: MauiApp2
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.12_name, ; name: libaot-MauiApp2.dll.so
		ptr null; void* handle (0x0)
	}, ; 803
	...
	%struct.DSOCacheEntry {
		i64 3388286720, ; hash 0xc9f52700, from name: libaot-OpenAI
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.49_name, ; name: libaot-OpenAI.dll.so
		ptr null; void* handle (0x0)
	}, ; 836
	...
	%struct.DSOCacheEntry {
		i64 3575481705, ; hash 0xd51d8569, from name: aot-MauiApp2.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.12_name, ; name: libaot-MauiApp2.dll.so
		ptr null; void* handle (0x0)
	}, ; 879
...
@assembly_store_bundled_assemblies = dso_local local_unnamed_addr global [202 x %struct.AssemblyStoreSingleAssemblyRuntimeData] zeroinitializer, align 4
